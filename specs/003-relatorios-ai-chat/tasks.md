...
- [x] **T1 — Add `GOOGLE_GENERATIVE_AI_API_KEY` parameter**
...
- [x] **T2 — Build the read-only SQL guard**
...
- [x] **T3 — Expose a read-only query execution path on the repository layer**
...
- [x] **T4 — Add build/tooling support for `.md` prompt imports and AI SDK dependencies**
...
- [x] **T6 — Build `contexts/ai.tsx` (`AiProvider` / `useAi`)**
...
- [x] **T8 — Wire the chat into the Relatórios page**
...
- [ ] **T10 — Manual verification** _(blocked: requires a real, user-supplied Google Generative AI API key — not available in this session)_
